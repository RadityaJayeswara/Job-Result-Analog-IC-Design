...
S {}
E {}
N -300 100 -230 100 {lab=VDD}
N -230 60 -230 100 {lab=VDD}
N -230 60 -170 60 {lab=VDD}
N -300 60 -270 60 {lab=#net1}
N -270 60 -270 80 {lab=#net1}
N -270 80 -170 80 {lab=#net1}
...
C {devices/iopin.sym} -230 130 1 0 {name=p2 lab=VDD}
